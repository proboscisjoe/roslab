...
(cl:in-package mora_husky_robot_localization-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mora_husky_robot_localization-srv:<SetDatum-request> is deprecated: use mora_husky_robot_localization-srv:SetDatum-request instead.")))

(cl:ensure-generic-function 'geo_pose-val :lambda-list '(m))
(cl:defmethod geo_pose-val ((m <SetDatum-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mora_husky_robot_localization-srv:geo_pose-val is deprecated.  Use mora_husky_robot_localization-srv:geo_pose instead.")
  (geo_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-request>)))
  ...
  "mora_husky_robot_localization/SetDatumRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-request)))
  "Returns string type for a service object of type 'SetDatum-request"
  "mora_husky_robot_localization/SetDatumRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mora_husky_robot_localization-srv:<SetDatum-response> is deprecated: use mora_husky_robot_localization-srv:SetDatum-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-response>)))
  ...
  "mora_husky_robot_localization/SetDatumResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-response)))
  "Returns string type for a service object of type 'SetDatum-response"
  "mora_husky_robot_localization/SetDatumResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum)))
  ...
  "mora_husky_robot_localization/SetDatum")