...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mora_husky_robot_localization-srv:<SetPose-request> is deprecated: use mora_husky_robot_localization-srv:SetPose-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <SetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mora_husky_robot_localization-srv:pose-val is deprecated.  Use mora_husky_robot_localization-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPose-request>)))
  ...
  "mora_husky_robot_localization/SetPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPose-request)))
  "Returns string type for a service object of type 'SetPose-request"
  "mora_husky_robot_localization/SetPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mora_husky_robot_localization-srv:<SetPose-response> is deprecated: use mora_husky_robot_localization-srv:SetPose-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPose-response>)))
  ...
  "mora_husky_robot_localization/SetPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPose-response)))
  "Returns string type for a service object of type 'SetPose-response"
  "mora_husky_robot_localization/SetPoseResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPose)))
  ...
  "mora_husky_robot_localization/SetPose")