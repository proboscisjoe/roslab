...
//MoRA 2016.3.14 replaced global hard-coded scan_topic_ with
//fetch from parameter server (param value set in amcl launch file)
...
class AmclNode
{
  ...
  private:
    ...
    //MoRA 2016.3.14 replaced global hard-coded scan_topic_ with
    //fetch from parameter server (param value set in amcl launch file)
    //this allows support for namespaced scan topics for multiple vehicles)
