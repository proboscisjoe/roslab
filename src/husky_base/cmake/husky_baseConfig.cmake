...
if("FALSE" STREQUAL "TRUE")
  set(husky_base_SOURCE_PREFIX /tmp/buildd/ros-indigo-husky-base-0.2.5-0trusty-20151231-1709)
  set(husky_base_DEVEL_PREFIX /tmp/buildd/ros-indigo-husky-base-0.2.5-0trusty-20151231-1709/obj-x86_64-linux-gnu/devel)
  ...
  set(husky_base_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'husky_base' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Paul Bovbel <pbovbel@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'husky_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Paul Bovbel <pbovbel@clearpathrobotics.com>' to fix it.")
    endif()
    _list_append_unique(husky_base_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "horizon_legacy;/usr/lib/x86_64-linux-gnu/libboost_chrono.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${husky_base_dep}_FOUND)
      find_package(${husky_base_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${husky_base_dep} REQUIRED ${depend_list})
  endif()
